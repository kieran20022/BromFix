        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed">
              Reparatie, onderhoud en verkoop van scooters en brommers. Specialist in Chinese 4-takt scooters.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-sm">
              ...
              <li><Link to="/prijslijst" className="hover:text-white transition-colors">Prijslijst</Link></li>
              <li><Link to="/verkoop" className="hover:text-white transition-colors">Verkoop</Link></li>
          ...
          {/* Location 1 */}
          <div>
            <h3 className="text-white text-sm font-semibold mb-3">Berkel en Rodenrijs</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-start gap-2">
                <MapPin className="w-3.5 h-3.5 mt-0.5 text-gray-500 shrink-0" />
                <span>Bij Auto Tinus<br />Hughersluys 9, 4536 HM</span>
              </li>
              <li className="flex items-center gap-2">
